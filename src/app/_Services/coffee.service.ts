...
export class CoffeeService {
  ...
  coffeeList = signal( [
    ...
    {
      name: 'Frappe',
      description: 'Iced coffee blended with milk and sugar for a refreshing and creamy drink.',
      price: 4.50,
      image: 'assets/frappe.jpg'
    },
    {
      name: 'Black Tea',
      description: 'Classic tea made from the leaves of the Camellia sinensis plant, known for its strong flavor and caffeine content.',
      price: 3.00,
      image: 'assets/blacktea.jpg'
    },
    {
      name: 'Iced Tea',
      description: 'Refreshing tea brewed and served cold, often sweetened and flavored with fruits.',
      price: 3.00,
